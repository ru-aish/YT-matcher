...
import { bricolage, archivo, jetbrains } from '../fonts'
import styles from './page.module.css'

const NICHES = ['Tech', 'Gaming', 'Beauty', 'Finance', 'Food']

const CREATORS = [
  { id: 'aria', name: 'Aria Vale', handle: '@ariabuilds', tags: ['Tech'], subs: 420, rate: 1800, hue: 18, base: 86, blurb: 'Calm, deep-dive product reviews for builders.' },
  { id: 'niko', name: 'Niko Frame', handle: '@nikoframe', tags: ['Gaming'], subs: 1200, rate: 5200, hue: 92, base: 80, blurb: 'High-energy playthroughs with a loyal core.' },
  ...
  { id: 'saffron', name: 'Saffron', handle: '@saffroneats', tags: ['Food'], subs: 560, rate: 2200, hue: 36, base: 84, blurb: 'Slow recipes, fast appetite. Big watch time.' },
  { id: 'pixel', name: 'Pixel Theory', handle: '@pixeltheory', tags: ['Tech', 'Gaming'], subs: 950, rate: 4100, hue: 150, base: 82, blurb: 'Where hardware nerds meet frame-rate fiends.' },
]
...
function buildScript(c, role) {
  ...
  return [
    ...
    { from: 'you', text: `Yeah — thinking a 60s dedicated slot. You open next week?` },
...
export default function MatchLab() {
  ...
  const ranked = useMemo(() => {
    return CREATORS.filter((c) => c.subs >= minSubs)
  ...
  return (
    <main
      ref={labRef}
      onMouseMove={onMove}
      className={`${bricolage.variable} ${archivo.variable} ${jetbrains.variable} ${styles.root}`}
    >
      ...
      <section className={styles.head}>
        <span className={styles.kicker}>Interactive · Match Lab</span>
        <h1 className={styles.title}>Tune the filters. Watch the matches re-rank live.</h1>
      </section>

      <div className={styles.controls}>
        <div className={styles.roleToggle} data-role={role}>
          <button
              ...
              <div className={styles.cardInner}>
                <div className={styles.cardTop}>
                  <span
                    ...
                    style={{
                      background: `radial-gradient(circle at 30% 30%, hsl(${c.hue} 90% 62%), hsl(${c.hue + 30} 80% 38%))`,
                    }}
                  />
                  <div>
                  ...
                  <span className={styles.fit} style={{ '--s': c.score }}>
                    {c.score}
                    <small>% fit</small>
                  </span>
                </div>
            ...
            <>
              <div className={styles.chatHead}>
                <span
                  ...
                  style={{
                    background: `radial-gradient(circle at 30% 30%, hsl(${selected.hue} 90% 62%), hsl(${selected.hue + 30} 80% 38%))`,
                  }}
                />
                <div>
