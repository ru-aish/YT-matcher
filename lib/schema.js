...
export const campaigns = pgTable('campaigns', {
  id: serial('id').primaryKey(),
  brandUserId: integer('brand_user_id').references(() => users.id),
  title: varchar('title', { length: 255 }).notNull(),
  targetAudienceCountry: varchar('target_audience_country', { length: 255 }),
  budgetMinUsd: integer('budget_min_usd').default(0),
  budgetMaxUsd: integer('budget_max_usd').default(0),
  requiredDeliverable: varchar('required_deliverable', { length: 255 }),
